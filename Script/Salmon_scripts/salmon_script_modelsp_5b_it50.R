...
save.image(file = 'salmon_allruns_model_5b_it50_sp.RData')
...
save(salmon_model_5b_best_it50, cormatrix_best_salmon_model_5b_it50, file = 'salmon_bestrun_model_5b_it50_sp.RData')