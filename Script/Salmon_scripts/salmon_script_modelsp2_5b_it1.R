...
save.image(file = 'salmon_allruns_model_5b_it1_sp2.RData')
...
save(salmon_model_5b_best_it1, cormatrix_best_salmon_model_5b_it1, file = 'salmon_bestrun_model_5b_it1_sp2.RData')