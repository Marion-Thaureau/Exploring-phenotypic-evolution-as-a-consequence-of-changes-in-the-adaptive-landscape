...
OUOUmodel.uptrid13C=fit.multivariate.OU(multid13Ci,A.matrix ="upper.tri", R.matrix = "diag", trace=TRUE, iterations=100, iter.sd=0.000001) 
# AICc = 
...
save.image(file='Hodell_Length_d13C_3sd.RData')
