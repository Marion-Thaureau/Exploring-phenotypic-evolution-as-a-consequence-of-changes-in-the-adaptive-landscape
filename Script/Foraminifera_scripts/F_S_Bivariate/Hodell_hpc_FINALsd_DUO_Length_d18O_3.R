...
OUOUmodel.uptrid18O=fit.multivariate.OU(multid18Oi,A.matrix ="upper.tri", R.matrix = "diag", trace=TRUE, iterations=100, iter.sd=0.000001) 
# AICc = 
...
save.image(file='Hodell_Length_d18O_3sd.RData')
