...
OUOUmodel.fullrowenvi=fit.multivariate.OU.user.defined(multiENVI,A.user=A,R.user=R, iterations=100, iter.sd=0.000001)
# AICc = 
...
save.image(file='Hodell_d18O_d13C_7sd.RData')





OUOUmodel.fullrowenvi
