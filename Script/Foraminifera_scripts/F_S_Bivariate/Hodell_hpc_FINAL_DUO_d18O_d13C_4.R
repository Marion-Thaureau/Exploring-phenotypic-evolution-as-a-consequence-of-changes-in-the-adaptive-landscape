...
#Loop foreach 
OUOUmodel.uprowenvi <- foreach(i=1:100) %dopar% { #calculation for each iteration 
...
for (j in 1:100) {
  ...
  AICvalues[j,2] = OUOUmodel.uprowenvi[[j]]$result2$AIC #AIC value
}
...
BESTRESULT=OUOUmodel.uprowenvi[[BestAICiteration]]
BESTRESULT




save.image(file='Hodell_d18O_d13C_4.RData')
