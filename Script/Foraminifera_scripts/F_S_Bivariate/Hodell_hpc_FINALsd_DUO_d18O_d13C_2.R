...
OUOUmodel.indepenvi=fit.multivariate.OU(multiENVI,A.matrix ="diag", R.matrix = "diag", trace=TRUE, iterations=100, iter.sd=0.000001) 
# AICc = 
...
save.image(file='Hodell_d18O_d13C_2sd.RData')
