...
OUOUmodel.indepd18O=fit.multivariate.OU(multid18Oi,A.matrix ="diag", R.matrix = "diag", trace=TRUE, iterations=100, iter.sd=0.000001) 
# AICc = 
...
save.image(file='Hodell_Length_d18O_2sd.RData')
