...
OUOUmodel.uprowd13C=fit.multivariate.OU.user.defined(multid13Ci,A.user=A,R.user=R, iterations=100, iter.sd=0.000001)
# AICc = 
...
save.image(file='Hodell_Length_d13C_4sd.RData')
