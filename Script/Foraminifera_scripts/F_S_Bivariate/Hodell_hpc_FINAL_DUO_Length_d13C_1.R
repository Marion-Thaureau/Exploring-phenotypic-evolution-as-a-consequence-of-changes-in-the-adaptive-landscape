...
modelURWd13Cdiag=fit.multivariate.URW(multid13Ci, R="diag", r="fixed",iterations=100,trace=TRUE)




##ACCELERATED AND DECELERATED MODELS
modelacceld13Cdiag=fit.multivariate.URW(multid13Ci, R="diag", r="accel",iterations=100,trace=TRUE)




modeldeceld13Cdiag=fit.multivariate.URW(multid13Ci, R="diag", r="decel",iterations=100,trace=TRUE)
...
save.image(file='Hodell_Length_d13C_1.RData')
