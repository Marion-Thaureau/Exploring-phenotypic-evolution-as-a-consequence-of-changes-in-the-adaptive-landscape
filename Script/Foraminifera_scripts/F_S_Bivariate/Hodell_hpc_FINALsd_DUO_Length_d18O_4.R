...
OUOUmodel.uprowd18O=fit.multivariate.OU.user.defined(multid18Oi,A.user=A,R.user=R, iterations=100, iter.sd=0.000001)
# AICc = 




save.image(file='Hodell_Length_d18O_4sd.RData')
