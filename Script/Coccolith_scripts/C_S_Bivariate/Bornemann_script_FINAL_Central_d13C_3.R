...
multienvi=make.multivar.evoTS(ln.lengthcentral, d13Ccarb)


## WITH INDEPENDANT EVOLUTION (1)
OUOUmodel.uppertridiagENVI=fit.multivariate.OU(multienvi,A.matrix ="upper.tri", R.matrix = "diag", trace=TRUE, iterations=100) 
# AICc = 
...
save.image(file='Bornemann_FINAL_Central_d13C_3.RData')



OUOUmodel.uppertridiagENVI
