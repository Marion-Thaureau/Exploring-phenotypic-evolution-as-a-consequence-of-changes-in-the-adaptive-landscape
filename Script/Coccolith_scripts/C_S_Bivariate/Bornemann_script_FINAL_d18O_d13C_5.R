...
OUOUmodel.lowertridiagENVI=fit.multivariate.OU(multienvi,A.matrix ="lower.tri", R.matrix = "diag", trace=TRUE, iterations=100) 
# AICc = 
...
save.image(file='Bornemann_FINAL_d18O_d13C_5.RData')


OUOUmodel.lowertridiagENVI
