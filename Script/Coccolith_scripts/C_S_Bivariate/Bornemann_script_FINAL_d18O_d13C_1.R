...
modelURWdiagENVI=fit.multivariate.URW(multienvi, R="diag", r="fixed",trace=TRUE, iterations=100)
# (1) AICc =




modelshiftENVI=fit.multivariate.URW.shift(multienvi, minb=10,trace=TRUE, iterations=100)
# (2) BEST SHIFT POINT =
# (2) AICc =
...
modelacceldiagENVI=fit.multivariate.URW(multienvi, R="diag", r="accel",trace=TRUE, iterations=100)
# (1) AICc = 
...
modeldeceldiagENVI=fit.multivariate.URW(multienvi, R="diag", r="decel",trace=TRUE, iterations=100)
# (2) AICc =
...
save.image(file='Bornemann_FINAL_d18O_d13C_1.RData')
