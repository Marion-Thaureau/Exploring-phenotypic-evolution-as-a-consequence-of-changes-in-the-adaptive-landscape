...
OUOUmodel.upperrowdiagENVI=fit.multivariate.OU.user.defined(multienvi,A.user=A,R.user=R, iterations=100)
# AICc = 
...
save.image(file='Bornemann_FINAL_Central_d13C_4.RData')



OUOUmodel.upperrowdiagENVI
