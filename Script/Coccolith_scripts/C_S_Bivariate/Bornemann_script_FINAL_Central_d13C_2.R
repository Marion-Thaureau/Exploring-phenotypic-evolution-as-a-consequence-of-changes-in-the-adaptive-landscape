...
OUOUmodel.indepdiagENVI=fit.multivariate.OU(multienvi,A.matrix ="diag", R.matrix = "diag", trace=TRUE, iterations=100) 
# AICc = 
...
save.image(file='Bornemann_FINAL_Central_d13C_2.RData')



OUOUmodel.indepdiagENVI
