...
OUOUmodel.lowerrowdiagENVI=fit.multivariate.OU.user.defined(multienvi,A.user=A,R.user=R, iterations=100)
# AICc = 
...
save.image(file='Bornemann_FINAL_d18O_d13C_6.RData')


OUOUmodel.lowerrowdiagENVI
