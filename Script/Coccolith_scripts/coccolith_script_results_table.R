...
coccolith_model_1a_best$A <- matrix(0, nrow = 3, ncol = 3)
coccolith_model_1a_best$optima <- rep(NA, 3)

coccolith_model_1b_best <- coccolith_model_1b
coccolith_model_1b_best$A <- matrix(0, nrow = 3, ncol = 3)
coccolith_model_1b_best$optima <- rep(NA, 3)
...
coccolith_result_table <- data.frame(
...
write.csv(coccolith_result_table, file = "../coccolith_results_table.csv", row.names = FALSE)
