########################################################
##                                                    ##
##  COCCOLITH SCRIPT - Model 2b (iteration 90 - 100)  ##
##                                                    ## 
########################################################
...
coccolith_model_2b_it90 <- foreach(i=1:100) %dopar% { 
...
save.image(file = 'coccolith_allruns_model_2b_it90.RData')



###### EXTRACTING AND SAVING THE ITERATION WITH BEST PARAMETER ESTIMATES ######
#Filtering 10 iterations which converged
coccolith_model_2b_it90_filtered <- Filter(function(iteration) !is.na(iteration$result2[[1]]), coccolith_model_2b_it90)
coccolith_model_2b_it90_filtered <- Filter(function(iteration) !is.null(iteration), coccolith_model_2b_it90_filtered)
coccolith_model_2b_it90_results <- coccolith_model_2b_it90_filtered[1:10]
...
for (j in 1:10) {
  AICc[j,1] <- j 
  AICc[j,2] <- coccolith_model_2b_it90_results[[j]]$result2$AICc 
}
...
coccolith_model_2b_best_it90 <- coccolith_model_2b_it90_results[[AICc_min]]

#calculating the correlation coefficients 
Rmatrix_best_coccolith_model_2b_it90 <- coccolith_model_2b_best_it90$result2$R
cormatrix_best_coccolith_model_2b_it90 <- cov2cor(Rmatrix_best_coccolith_model_2b_it90)

#Saving the best iteration
print(coccolith_model_2b_best_it90)
print(cormatrix_best_coccolith_model_2b_it90)
save(coccolith_model_2b_best_it90, cormatrix_best_coccolith_model_2b_it90, file = 'coccolith_bestrun_model_2b_it90.RData')